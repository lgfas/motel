package com.luisguilherme.motel.mapper.queryRh.model;
...
public class QueryRhModel {
    ...
    public String queryCodigoServidor (Integer codServidor) {
        ...
        query.append("""
                SELECT
                    ...
                    cg04rh56.cg04_cod_orgao_expedidor as idOrgaoExpedidor,
                    cg04rh56.cg04_descricao as descricaoOrgaoExpedidor,
    ...
    public String queryMatriculaNomeCpf(String cpf, String nome, String matricula) {
        ...
        if (cpf != null) query.append("""
                AND rh56.rh56_cpf = '""").append(cpf).append("'")
                .append("""
        ...
        if (nome != null) query.append("""
                AND rh01.rh01_nome = '""").append(nome).append("'")
                .append("""
        ...
        if (matricula != null) query.append("""
                AND rh02.rh02_matricula = '""").append(matricula).append("'")
                .append("""
